...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchemaHash": "0f720eeb4b2771578c1c66d33e0ed82bd8bcc2d04008f0a04fc33a076f130308",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
...
/**
  ...
  /**
   * `prisma.textEntry`: Exposes CRUD operations for the **TextEntry** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more TextEntries
    * const textEntries = await prisma.textEntry.findMany()
    * ```
    */
  get textEntry(): Prisma.TextEntryDelegate<ExtArgs, { omit: OmitOpts }>;

  /**
   * `prisma.boxClientInfo`: Exposes CRUD operations for the **BoxClientInfo** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more BoxClientInfos
    * const boxClientInfos = await prisma.boxClientInfo.findMany()
    * ```
    */
  get boxClientInfo(): Prisma.BoxClientInfoDelegate<ExtArgs, { omit: OmitOpts }>;
}
