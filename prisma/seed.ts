...
async function main() {
  const texts = [
    ...
    { key: "welcome.title", value: "Bienvenue sur Boxin1", lang: "fr" },
    {
      ...
      value:
        "Votre partenaire pour la transformation de votre maison en maison intelligente",
      lang: "fr",
    },
    ...
    { key: "about.title", value: "À propos de Boxin1", lang: "fr" },
    {
      key: "about.text",
      value:
        "Boxin1 est une entreprise innovante spécialisée dans la transformation des habitations traditionnelles en maisons intelligentes connectées. Nous rendons la technologie accessible à tous.",
      lang: "fr",
    },
    ...
    { key: "app.title", value: "Notre Application", lang: "fr" },
    {
      key: "app.text",
      value:
        "Cette plateforme vous permet de contrôler, surveiller et automatiser tous les aspects de votre maison intelligente depuis n'importe où, à tout moment.",
      lang: "fr",
    },
    ...
    {
      key: "features.control.text",
      value:
        "Gérez tous vos appareils intelligents depuis une seule interface intuitive.",
      lang: "fr",
    },
    { key: "features.automation.title", value: "Automatisation", lang: "fr" },
    {
      key: "features.automation.text",
      value:
    ...
    {
      key: "features.security.text",
      value:
        "Surveillance et contrôle d'accès avec notifications en temps réel.",
      lang: "fr",
    },
    { key: "features.energy.title", value: "Économie d'Énergie", lang: "fr" },
    {
      key: "features.energy.text",
      value:
        "Optimisez votre consommation énergétique avec l'intelligence artificielle.",
      lang: "fr",
    },
    ...
    {
      key: "quickstart.step2",
      value: "Configurez vos préférences",
      lang: "fr",
    },
    {
      key: "quickstart.step3",
      value: "Profitez de votre maison intelligente",
      lang: "fr",
    },
    ...
    {
      key: "mobilecontrol.text",
      value:
        "Accédez à votre maison depuis n'importe où avec notre application mobile. Contrôlez l'éclairage, la température, la sécurité et bien plus encore.",
      lang: "fr",
    },
    ...
    {
      key: "cta.title",
      value: "Prêt à transformer votre maison ?",
      lang: "fr",
    },
    {
      key: "cta.text",
      value:
        "Découvrez toutes les possibilités que Boxin1 peut offrir à votre domicile.",
      lang: "fr",
    },
    ...
    { key: "profile.title", value: "Paramètres du compte", lang: "fr" },
    {
      ...
      value: "Gérer vos informations et vos paramètres du compte",
      lang: "fr",
    },
    ...
    {
      key: "profile.info.photoFormat",
      value: "JPG, GIF ou PNG. Max 2MB.",
      lang: "fr",
    },
    ...
    {
      key: "profile.security.currentPassword",
      value: "Mot de passe actuel",
      lang: "fr",
    },
    {
      key: "profile.security.currentPasswordPlaceholder",
      value: "Entrez votre mot de passe actuel",
      lang: "fr",
    },
    {
      key: "profile.security.newPassword",
      value: "Nouveau mot de passe",
      lang: "fr",
    },
    {
      key: "profile.security.newPasswordPlaceholder",
      value: "Entrez un nouveau mot de passe",
      lang: "fr",
    },
    {
      key: "profile.security.confirmPassword",
      value: "Confirmer le mot de passe",
      lang: "fr",
    },
    {
      key: "profile.security.confirmPasswordPlaceholder",
      value: "Confirmez votre nouveau mot de passe",
      lang: "fr",
    },
    {
      key: "profile.security.twoFactor",
      value: "Authentification à deux facteurs",
      lang: "fr",
    },
    {
      key: "profile.security.twoFactorDesc",
    ...
    // App Preferences
    {
      key: "profile.preferences.title",
      value: "Préférences de l'application",
      lang: "fr",
    },
    {
      key: "profile.preferences.pushNotifications",
      value: "Notifications push",
      lang: "fr",
    },
    {
      key: "profile.preferences.pushNotificationsDesc",
      value: "Recevoir des notifications sur votre appareil",
      lang: "fr",
    },
    {
      key: "profile.preferences.emailNotifications",
      value: "Notifications email",
      lang: "fr",
    },
    {
      key: "profile.preferences.emailNotificationsDesc",
      value: "Recevoir des emails de l'application",
      lang: "fr",
    },
    { key: "profile.preferences.darkMode", value: "Mode sombre", lang: "fr" },
    {
      key: "profile.preferences.darkModeDesc",
      value: "Utiliser le thème sombre",
      lang: "fr",
    },
    ...
    // Privacy and Data
    {
      key: "profile.privacy.title",
      value: "Confidentialité et données",
      lang: "fr",
    },
    {
      key: "profile.privacy.publicProfile",
      value: "Profil public",
      lang: "fr",
    },
    {
      key: "profile.privacy.publicProfileDesc",
      value: "Permettre aux autres utilisateurs de voir votre profil",
      lang: "fr",
    },
    { key: "profile.privacy.usageData", value: "Données d'usage", lang: "fr" },
    {
      key: "profile.privacy.usageDataDesc",
      value: "Partager des données anonymes pour améliorer l'app",
      lang: "fr",
    },
    {
      key: "profile.privacy.downloadData",
      value: "Télécharger mes données",
      lang: "fr",
    },
    {
      key: "profile.privacy.deleteAccount",
